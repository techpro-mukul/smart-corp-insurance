...
class PoliciesIssued extends React.Component {
    componentDidMount() {
        this.props.getUsers();
...
const connectedPoliciesIssued = connect(mapState, actionCreators)(PoliciesIssued);
export { connectedPoliciesIssued as PoliciesIssued };