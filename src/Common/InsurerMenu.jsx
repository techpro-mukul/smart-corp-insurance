        ...
        return (
            <div className="col-md-10 col-md-offset-3">
                ...
                <div style={{color:"blue", fontSize: "12px", alignContent: "center"}}>                    
                    ...
                    <br></br>
                    <Link to="/insurerHome" className="btn btn-link" style={{float:"left", padding:"0px"}}>Home</Link>         
...
const connectedInsurerMenu
 = connect(mapState)(InsurerMenu
);
export { connectedInsurerMenu
 as InsurerMenu
 };