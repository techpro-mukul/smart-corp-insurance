        ...
        return (
            <div className="col-md-10 col-md-offset-3">
                ...
                <div style={{color:"blue", fontSize: "12px", alignContent: "center"}}>                    
                    ...
                    <br></br>
                    <Link to="/weatherDeptHome" className="btn btn-link" style={{float:"left", padding:"0px"}}>Home</Link>         
...
const connectedWeatherDeptMenu

 = connect(mapState)(WeatherDeptMenu

);
export { connectedWeatherDeptMenu
